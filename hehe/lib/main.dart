...
class MyCard extends State<Home>{
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          title: Image.asset('img/listreminder.png', height:60, width: 80,),
          backgroundColor: Colors.deepOrange,
        ),
        body: new Container(
            child: new ListView(
...
class Tambah extends State<StateTambah>{
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: Image.asset('img/quinget.png', height: 50, width: 50,),
        backgroundColor: Colors.deepOrange,
      ),
      body: new Padding(padding: EdgeInsets.all(20.0),
        child: new Column(
          children: <Widget>[
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          title: Row(
            children: <Widget>[
            Image.asset('img/history.png', height: 50,width: 50,),
              Text("Reminder")
            ],
          ),
          backgroundColor: Colors.deepOrange,
